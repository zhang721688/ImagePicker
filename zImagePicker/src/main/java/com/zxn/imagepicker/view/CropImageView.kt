 ...
 */
class CropImageView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : AppCompatImageView(context, attrs, defStyle) {
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        when (event.action and MotionEvent.ACTION_MASK) {
            ...
            MotionEvent.ACTION_POINTER_DOWN -> {
                //if (event.actionIndex > 1) break@event
